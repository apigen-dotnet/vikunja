...
public partial class UserClient : IUserClient
{
  ...
  /// Operation: GET /user
  /// </summary>
  public async Task<UserWithSettings> GetAsync(CancellationToken cancellationToken = default)
  {
    string url = "user";
  ...
  /// </summary>
  public async Task<UserExportStatus> GetuserAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Message> UpdateUserSettingsAsync(Apigen.Vikunja.Models.UserGeneralSettings userGeneralSettings, CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "POST", url);
      string json = JsonSerializer.Serialize(userGeneralSettings, JsonConfig.Default);
      HttpClientLog.LogTraceRequestBody(_logger, "POST", "application/json", json);
      StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
      HttpResponseMessage response = await _httpClient.PostAsync(url, content, cancellationToken);
      long durationMs = (long)System.Diagnostics.Stopwatch.GetElapsedTime(startTimestamp).TotalMilliseconds;
  ...
  /// </summary>
  public async Task<Message> DeleteuserAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<string> GetUserSettingsTotpQrcodeAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// Operation: GET /users
  /// </summary>
  public async Task<List<User>> GetUsersAsync(GetuserRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Stream> GetuserAsync(string username, GetuserRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["username"] = username
