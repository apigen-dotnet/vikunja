...
public partial class TeamClient : ITeamClient
{
  ...
  /// Operation: GET /teams
  /// </summary>
  public async Task<List<Team>> GetteamAsync(GetteamRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Message> DeleteteamAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Message> DeleteteamAsync(int id, int username, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
