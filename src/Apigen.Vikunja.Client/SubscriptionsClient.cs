...
public partial class SubscriptionsClient : ISubscriptionsClient
{
  ...
  /// </summary>
  public async Task<Message> DeletesubscriptionsAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Subscription> DeletesubscriptionsAsync(string entity, string entityId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["entity"] = entity,
