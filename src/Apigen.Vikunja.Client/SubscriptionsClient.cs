...
public partial class SubscriptionsClient
{
  ...
  /// </summary>
  public async Task<List<DatabaseNotification>> GetsubscriptionsAsync(GetsubscriptionsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<DatabaseNotifications> MarkNotificationReadAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Subscription> SubscribeAsync(string entity, string entityId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["entity"] = entity,
  ...
  /// </summary>
  public async Task<Subscription> DeleteAsync(string entity, string entityId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["entity"] = entity,
