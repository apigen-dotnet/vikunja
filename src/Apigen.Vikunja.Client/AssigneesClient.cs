...
/// </summary>
public partial class AssigneesClient : IAssigneesClient
{
  ...
  /// </summary>
  public async Task<List<User>> GetassigneesAsync(int taskId, GetassigneesRequest? request = null, CancellationToken cancellationToken = default)
  {
