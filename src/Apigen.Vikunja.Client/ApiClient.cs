...
public partial class ApiClient : IApiClient
{
  ...
  /// </summary>
  public async Task<List<ApiTokenRoute>> GetapiAsync(CancellationToken cancellationToken = default)
  {
    string url = "routes";
  ...
  /// </summary>
  public async Task<List<ApiToken>> GetTokensAsync(GetapiRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Message> DeleteapiAsync(int tokenId, CancellationToken cancellationToken = default)
  {
