...
public partial interface ITaskClient
{
  ...
  /// </summary>
  Task<TaskItem> GetTaskByIndexAsync(string project, int index, GetTaskByIndexRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeletetaskAsync(int id, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeletetaskAsync(int id, int attachmentId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeletetaskAsync(int taskId, string relationKind, int otherTaskId, Apigen.Vikunja.Models.TaskRelation taskRelation, CancellationToken cancellationToken = default);
