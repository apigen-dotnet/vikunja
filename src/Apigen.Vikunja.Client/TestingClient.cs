...
/// </summary>
public partial class TestingClient : ITestingClient
{
  ...
  /// </summary>
  public async Task<List<User>> PatchtestingAsync(string table, CancellationToken cancellationToken = default)
  {
