...
public interface ISharingClient
{
  ...
  /// </summary>
  Task<List<TeamWithPermission>> GetAsync(int id, GetsharingRequest? request = null);

  /// <summary>
  /// Add a team to a project
  /// Operation: PUT /projects/{id}/teams
  /// </summary>
  Task<TeamProject> AddTeamToProjectAsync(int id, Apigen.Vikunja.Models.TeamProject teamProject);

  /// <summary>
  /// Get users on a project
  /// Operation: GET /projects/{id}/users
  /// </summary>
  Task<List<UserWithPermission>> GetProjectsUsersAsync(int id, GetsharingRequest? request = null);

  /// <summary>
  /// Add a user to a project
  /// Operation: PUT /projects/{id}/users
  /// </summary>
  Task<ProjectUser> AddUserToProjectAsync(int id, Apigen.Vikunja.Models.ProjectUser projectUser);
  ...
  /// </summary>
  Task<List<LinkSharing>> GetProjectsSharesAsync(int project, GetsharingRequest? request = null);

  /// <summary>
  /// Share a project via link
  /// Operation: PUT /projects/{project}/shares
  /// </summary>
  Task<LinkSharing> CreateProjectShareAsync(int project, Apigen.Vikunja.Models.LinkSharing linkSharing);

  /// <summary>
  /// Get one link shares for a project
  /// Operation: GET /projects/{project}/shares/{share}
  /// </summary>
  Task<LinkSharing> GetAsync(int project, int share);

  /// <summary>
  /// Remove a link share
  /// Operation: DELETE /projects/{project}/shares/{share}
  /// </summary>
  Task<Message> DeleteProjectsSharesAsync(int project, int share);

  /// <summary>
  /// Get an auth token for a share
  /// Operation: POST /shares/{share}/auth
  /// </summary>
  Task<AuthToken> AuthenticateShareAsync(string share, Apigen.Vikunja.Models.LinkShareAuth linkShareAuth);
