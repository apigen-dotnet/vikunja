...
public partial interface ISharingClient
{
  ...
  /// </summary>
  Task<Message> PostsharingAsync(CancellationToken cancellationToken = default);

  /// <summary>
  /// Get teams on a project
  /// Operation: GET /projects/{id}/teams
  /// </summary>
  Task<List<TeamWithPermission>> GetsharingAsync(int id, GetsharingRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeletesharingAsync(int projectId, int teamId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<LinkSharing> GetsharingAsync(int project, int share, CancellationToken cancellationToken = default);
