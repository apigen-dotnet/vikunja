...
public partial class LabelsClient : ILabelsClient
{
  ...
  /// </summary>
  public async Task<LabelTaskBulk> PostlabelsAsync(int taskId, Apigen.Vikunja.Models.LabelTaskBulk labelTaskBulk, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["taskID"] = taskId
  ...
  /// </summary>
  public async Task<List<Label>> GetlabelsAsync(int task, GetlabelsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["task"] = task
