...
public partial class MigrationClient : IMigrationClient
{
  ...
  /// </summary>
  public async Task<AuthUrl> GetmigrationAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Message> PutmigrationAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Message> PostmigrationAsync(CancellationToken cancellationToken = default)
  {
