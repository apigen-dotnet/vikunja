...
public partial interface IProjectClient
{
  ...
  /// </summary>
  Task<List<Project>> GetprojectAsync(GetprojectRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeleteprojectAsync(int id, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<List<User>> GetProjectsProjectusersAsync(int id, GetprojectRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Get all kanban buckets of a project
  /// Operation: GET /projects/{id}/views/{view}/buckets
  /// </summary>
  Task<List<Bucket>> GetprojectAsync(int id, int view, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeleteprojectAsync(int projectId, int bucketId, int view, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeleteprojectAsync(int project, int id, CancellationToken cancellationToken = default);
