...
public partial class AuthClient : IAuthClient
{
  ...
  public async Task<LogoutResponse> LogoutAsync(CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      ...
      string responseContent = await response.Content.ReadAsStringAsync(cancellationToken);
      HttpClientLog.LogTraceResponseBody(_logger, url, responseContent);
      LogoutResponse? result = JsonSerializer.Deserialize<LogoutResponse>(responseContent, JsonConfig.Default);
      return result ?? new LogoutResponse();
    }
    catch (OperationCanceledException) when (cancellationToken.IsCancellationRequested)
    {
      HttpClientLog.LogDebugRequestCancelled(_logger, "POST", url);
  ...
  /// </summary>
  public async Task<AuthToken> PostauthAsync(CancellationToken cancellationToken = default)
  {
