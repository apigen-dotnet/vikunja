...
/// </summary>
public partial class SharingClient : ISharingClient
{
  ...
  /// </summary>
  public async Task<Message> PostsharingAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<List<TeamWithPermission>> GetsharingAsync(int id, GetsharingRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Message> DeletesharingAsync(int projectId, int teamId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["projectID"] = projectId,
  ...
  /// </summary>
  public async Task<LinkSharing> GetsharingAsync(int project, int share, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["project"] = project,
