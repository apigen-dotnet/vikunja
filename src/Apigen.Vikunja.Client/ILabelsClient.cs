...
public partial interface ILabelsClient
{
  ...
  /// </summary>
  Task<LabelTaskBulk> PostlabelsAsync(int taskId, Apigen.Vikunja.Models.LabelTaskBulk labelTaskBulk, CancellationToken cancellationToken = default);

  /// <summary>
  /// Get all labels on a task
  /// Operation: GET /tasks/{task}/labels
  /// </summary>
  Task<List<Label>> GetlabelsAsync(int task, GetlabelsRequest? request = null, CancellationToken cancellationToken = default);
