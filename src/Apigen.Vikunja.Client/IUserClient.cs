...
public partial interface IUserClient
{
  ...
  /// Operation: GET /user
  /// </summary>
  Task<UserWithSettings> GetAsync(CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<UserExportStatus> GetuserAsync(CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> UpdateUserSettingsAsync(Apigen.Vikunja.Models.UserGeneralSettings userGeneralSettings, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<Message> DeleteuserAsync(int id, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<string> GetUserSettingsTotpQrcodeAsync(CancellationToken cancellationToken = default);
  ...
  /// Operation: GET /users
  /// </summary>
  Task<List<User>> GetUsersAsync(GetuserRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// User Avatar
  /// Operation: GET /{username}/avatar
  /// </summary>
  Task<Stream> GetuserAsync(string username, GetuserRequest? request = null, CancellationToken cancellationToken = default);
