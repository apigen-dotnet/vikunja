...
/// </summary>
public partial class FilterClient : IFilterClient
{
  ...
  /// </summary>
  public async Task<SavedFilter> GetfilterAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<SavedFilter> DeletefilterAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
